...
export const PERU_LOCAL_PLACES: PlaceSuggestion[] = [
  // Lima (Costa)
  {
    description: "Barranco, Lima",
    district: "Barranco",
    region: "costa",
    coords: { lat: -12.1492, lng: -77.0222 },
  },
  {
    description: "Miraflores, Lima",
    district: "Miraflores",
    region: "costa",
    coords: { lat: -12.1225, lng: -77.028 },
  },
  {
    description: "San Juan de Lurigancho, Lima",
    district: "San Juan de Lurigancho",
    region: "costa",
    coords: { lat: -12.0263, lng: -76.9873 },
  },
  {
    description: "Chorrillos, Lima",
    district: "Chorrillos",
    region: "costa",
    coords: { lat: -12.1762, lng: -77.0269 },
  },
  {
    description: "San Isidro, Lima",
    district: "San Isidro",
    region: "costa",
    coords: { lat: -12.0974, lng: -77.0349 },
  },
  {
    description: "Santiago de Surco, Lima",
    district: "Santiago de Surco",
    region: "costa",
    coords: { lat: -12.1417, lng: -76.9786 },
  },
  {
    description: "La Molina, Lima",
    district: "La Molina",
    region: "costa",
    coords: { lat: -12.0914, lng: -76.9248 },
  },
  {
    description: "Villa El Salvador, Lima",
    district: "Villa El Salvador",
    region: "costa",
    coords: { lat: -12.2081, lng: -76.9367 },
  },
  {
    description: "Magdalena del Mar, Lima",
    district: "Magdalena del Mar",
    region: "costa",
    coords: { lat: -12.0903, lng: -77.0706 },
  },
  {
    description: "Callao, Callao",
    district: "Callao",
    region: "costa",
    coords: { lat: -12.0566, lng: -77.1181 },
  },
  {
    description: "Lince, Lima",
    district: "Lince",
    region: "costa",
    coords: { lat: -12.0834, lng: -77.0353 },
  },
  {
    description: "Rímac, Lima",
    district: "Rímac",
    region: "costa",
    coords: { lat: -12.0294, lng: -77.028 },
  },

  // Cusco (Sierra)
  {
    description: "Chinchero, Cusco",
    district: "Chinchero",
    region: "sierra",
    coords: { lat: -13.3914, lng: -72.0468 },
  },
  {
    description: "Cusco Centro, Cusco",
    district: "Cusco",
    region: "sierra",
    coords: { lat: -13.5319, lng: -71.9675 },
  },
  {
    description: "Wanchaq, Cusco",
    district: "Wanchaq",
    region: "sierra",
    coords: { lat: -13.5224, lng: -71.9592 },
  },
  {
    description: "Pisac, Valle Sagrado",
    district: "Pisac",
    region: "sierra",
    coords: { lat: -13.4219, lng: -71.8481 },
  },
  {
    description: "Ollantaytambo, Valle Sagrado",
    district: "Ollantaytambo",
    region: "sierra",
    coords: { lat: -13.2581, lng: -72.2634 },
  },
  {
    description: "San Jerónimo, Cusco",
    district: "San Jerónimo",
    region: "sierra",
    coords: { lat: -13.5422, lng: -71.8906 },
  },

  // Loreto (Selva)
  {
    description: "Iquitos Centro, Loreto",
    district: "Iquitos",
    region: "selva",
    coords: { lat: -3.7452, lng: -73.2516 },
  },
  {
    description: "Punchana, Loreto",
    district: "Punchana",
    region: "selva",
    coords: { lat: -3.7294, lng: -73.2428 },
  },
  {
    description: "Belén, Loreto",
    district: "Belén",
    region: "selva",
    coords: { lat: -3.7612, lng: -73.2561 },
  },
  {
    description: "San Juan Bautista, Iquitos",
    district: "San Juan Bautista",
    region: "selva",
    coords: { lat: -3.7852, lng: -73.275 },
  },

  // Trujillo (Costa)
  {
    description: "Trujillo Centro, La Libertad",
    district: "Trujillo",
    region: "costa",
    coords: { lat: -8.1119, lng: -79.0287 },
  },
  {
    description: "Huanchaco, La Libertad",
    district: "Huanchaco",
    region: "costa",
    coords: { lat: -8.0772, lng: -79.1189 },
  },
  {
    description: "Alto Trujillo, La Libertad",
    district: "Alto Trujillo",
    region: "costa",
    coords: { lat: -8.082, lng: -79.001 },
  },
  {
    description: "Víctor Larco Herrera, La Libertad",
    district: "Víctor Larco",
    region: "costa",
    coords: { lat: -8.1344, lng: -79.0436 },
  },

  // Puno (Sierra)
  {
    description: "Puno Centro, Puno",
    district: "Puno",
    region: "sierra",
    coords: { lat: -15.8402, lng: -70.0219 },
  },
  {
    description: "Juliaca, Puno",
    district: "Juliaca",
    region: "sierra",
    coords: { lat: -15.4967, lng: -70.1333 },
  },
  {
    description: "Chucuito, Puno",
    district: "Chucuito",
    region: "sierra",
    coords: { lat: -15.8894, lng: -69.8894 },
  },

  // Arequipa (Sierra)
  {
    description: "Arequipa Centro, Arequipa",
    district: "Arequipa",
    region: "sierra",
    coords: { lat: -16.409, lng: -71.5375 },
  },
  {
    description: "Yanahuara, Arequipa",
    district: "Yanahuara",
    region: "sierra",
    coords: { lat: -16.3886, lng: -71.5414 },
  },
];
...
export async function getPlaceSuggestions(input: string): Promise<PlaceSuggestion[]> {
    ...
    try {
      ...
      if (data.status === "OK" && data.results) {
        return data.results.map((res: any) => {
          ...
          const adminAreaComp = res.address_components.find((c: any) =>
            c.types.includes("administrative_area_level_3"),
          );

          district =
            localityComp?.long_name ||
            adminAreaComp?.long_name ||
  ...
  return PERU_LOCAL_PLACES.filter((place) => {
    const normDesc = place.description
      .toLowerCase()
      .normalize("NFD")
      .replace(/[\u0300-\u036f]/g, "");
...
export async function reverseGeocode(
  coords: MapCoords,
): Promise<{ district: string; region: "costa" | "sierra" | "selva" }> {
