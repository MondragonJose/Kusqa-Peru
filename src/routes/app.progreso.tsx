  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-12">
        ...
        <div className="relative grid lg:grid-cols-[1fr_auto] gap-8 items-center">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="rounded-2xl bg-white/10 backdrop-blur-md px-4 py-4 text-center min-w-[94px] border border-white/10 shadow-sm">
              <div className="font-display font-black text-2xl tracking-tight text-white">{earnedBadgesCount}</div>
              <div className="text-[9px] uppercase tracking-widest text-white/70 font-semibold mt-1">Insignias</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        <div>
          <h2 className="font-display font-black text-2xl tracking-tight text-foreground">Tu recorrido territorial</h2>
          <p className="text-sm text-muted-foreground">Historial visual de tu participación por regiones.</p>
        </div>
      ...
      <section className="space-y-4">
        <div className="space-y-4">
          <h2 className="font-display font-black text-2xl tracking-tight text-foreground">Misiones</h2>
          ...
          <div className="rounded-3xl border border-dashed border-border p-8 text-center bg-muted/20">
            ...
            <p className="text-sm text-muted-foreground font-medium">Explora el mapa para encontrar misiones activas</p>
            <p className="text-xs text-muted-foreground/70 mt-1">Tu recorrido territorial puede comenzar aquí.</p>
            <Link to="/app/mapa" className="inline-block bg-gradient-sunrise hover:scale-[1.02] text-white font-semibold px-4 py-2 rounded-xl text-xs shadow-glow transition-all duration-300">
              Ir al mapa
            </Link>
          </div>
        </div>
